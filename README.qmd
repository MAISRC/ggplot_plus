...
Just by loading `ggplot.plus`, you will switch your session's default color palette to one that is more broadly accessible–there's no need to call `palettes_plus()` to alter this palette unless you want to (see the "Colorblind-Friendly Palettes" section for details):
