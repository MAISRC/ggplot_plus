...
```{r stay left justified, message=FALSE}
ggplot(iris,
       mapping = aes(x = Petal.Length, 
           y = Sepal.Length)) +
  geom_plus(geom = "point", 
...
```{r see size matters, message=FALSE}
ggplot(iris,
       mapping = aes(x = Petal.Length, 
           y = Sepal.Length)) +
  geom_plus(geom = "point", 
...
```{r geom_plus access, message=FALSE}
#| fig-height: 6.5
#| fig-width: 9
...
```{r using custom shapes on their own, message=FALSE}
ggplot(iris,
       mapping = aes(x = Petal.Length, 
           y = Sepal.Length)) +
...
```{r message no custom titles, message=TRUE}
ggplot(iris,
       mapping = aes(x = Petal.Length, 
           y = Sepal.Length)) +
  geom_plus(geom = "point", 
...
```{r warning about less contrast, message=TRUE}
ggplot(iris,
       mapping = aes(x = Petal.Length, 
           y = Sepal.Length)) +
  geom_plus(geom = "point", 
