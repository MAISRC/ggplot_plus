---
title: "Guide to the ggplotplus Package"
...
To use the `ggplotplus` package, you’ll need to first install it from GitHub using the `devtools` package (you only need to do this once for each release of the package):
...
```{r geom list}
sort(names(ggplotplus:::.geom_plus_defaults()))
```
