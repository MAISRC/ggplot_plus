...
options(
  ggplot2.discrete.fill = function(...) { ggplot2::scale_fill_viridis_d(begin = begin, end = end, option = palette,  ...) },
  ggplot2.discrete.colour = function(...) { ggplot2::scale_colour_viridis_d(begin = begin, end = end, option = palette, ...) },
  ggplot2.continuous.fill = function(...) { ggplot2::scale_fill_viridis_c(begin = begin, end = end, option = palette, ...) },
  ggplot2.continuous.colour = function(...) { ggplot2::scale_colour_viridis_c(begin = begin, end = end, option = palette, ...) }
)
}
